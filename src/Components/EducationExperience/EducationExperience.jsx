                    ...
                    <h2>Work Experience</h2>
                      <div className="experience_content">
                        ...
                        <div className="container experience_p">
                          ...
                          <p>
                            2. Implemented frontend components and user
                            interfaces using React-Vite with Material-UI
                          ...
                          <p>
                            4. Utilized TypeORM for ORM operations, managing
                            MySQL databases efficiently.
                          </p>
                          <p>
                            5. Collaborated with cross-functional teams to
                            gather requirements, plan features, and deliver
                    ...
                    <h2>Internship</h2>
                      <div className="experience_content">
                        <h6>Web Development</h6>
                          <h6>Snowtex Outerwear LTD. <span>Dhamrai, Dhaka.</span> </h6>
                        <div className="container experience_p">
                          <p>
                          ...
                          <p>
                            2. Contributed to the frontend development of
                            projects using React.js, ensuring responsive and
